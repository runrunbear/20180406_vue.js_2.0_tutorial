...
<div class="col-sm-12" style="margin-top:20px;">
      ...
      <table id="dynamic-table" class="display table table-bordered table-striped dataTable" aria-describedby="dynamic-table_info">
        ...
        <script type="text/javascript">
              function fun(id){
                    if(confirm("确定要删除吗?")){
                        $.get("/cuijiwei/project/index.php/Admin/Friend/delete",{id:id},function(data){
                                if(data==1){
                                    alert("删除成功");
                                    document.location="/cuijiwei/project/index.php/Admin/Friend/index";
                                }
                        })
                    }
